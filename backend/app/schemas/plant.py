...
# "cutting" is created via its own endpoint (it always needs a pot), not here.
...
class CuttingCreate(BaseModel):
    # A cutting always goes into its own pot; a new container is made automatically.
    new_location_name: str | None = None


class TransplantCreate(BaseModel):
    """Plant a rooting cutting out into a real location."""
